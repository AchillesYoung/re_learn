...
public class ObjectIOTest {
    ...
    public void test1() throws IOException {
        ...
        // 1.创建序列化流对象
        ObjectOutputStream oos = new ObjectOutputStream(new FileOutputStream("src/serialize/person3.dat"));
    ...
    public void test2() throws ClassNotFoundException, IOException {
        // 1.创建反序列化流对象
        ObjectInputStream ois = new ObjectInputStream(new FileInputStream("src/serialize/person3.dat"));
