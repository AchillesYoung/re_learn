...
import reflection.java1.MyInterfaceImpl;
...
public class MyInterface {
    ...
    public static void main(String[] args) throws Exception {
        List<MyInterface> myInterface = new ArrayList<>();
        List<Class> clazzs = getAllInterfaceAchieveClass(MyInterface.class);
        for (Class clazz : clazzs) {
            myInterface.add((MyInterface) clazz.newInstance());
        }
        //打印Class对象
        for (MyInterface cla : myInterface) {
